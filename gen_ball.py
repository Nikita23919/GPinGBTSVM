...
class GranularBall:
    ...
    def __init__(self, data):
        """
        :param data:  Labeled data set, the "-2" column is the class label
        """
        self.data = data[:, :]
    ...
    def split_2balls(self):
        ...
        if sum(label_cluster == 0) and sum(label_cluster == 1):
            ball1 = GranularBall(self.data[label_cluster == 0, :]) #return data points with their actual label of ball1
            ball2 = GranularBall(self.data[label_cluster == 1, :]) #return data points with their actual label of ball2
        else:
...
class GBList:
    ...
    def __init__(self, data=None):
        self.data = data[:, :]
        self.granular_balls = [GranularBall(self.data)]  # GB list is initialized with all data
...
def gen_balls(data,pur,delbals):
    # data_file = "//Users/nikita/Library/CloudStorage/OneDrive-iitr.ac.in/Safari Downloads/banana.dat"
